...
//  final loadedCategory = Provider.of<Categories>(context).categories.firstWhere((cat) => cat.id == categoryName);
  ...
  // ),
      ...
      floatingActionButton:   FloatingActionButton(onPressed: (() {
                Navigator.push(context, MaterialPageRoute(builder: (context) => UpdateMeasurements()));
        ...
        height: 500,
         ...
         borderRadius: BorderRadius.circular(20), //13
            ...
            child: UpdateMeasureWidget(
              categories[i].title, categories[i].numberr, categories[i].id, //categories[i].icons categories[i].title
